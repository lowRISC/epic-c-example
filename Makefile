...
cm: $(CLANG) Makefile coremark app.lds htif.c htif.h addrs.h crt0.c coremark-port/core_portme.c coremark-port/core_portme.h coremark-port/cvt.c coremark-port/ee_printf.c coremark/core_list_join.c coremark/core_main.c coremark/core_matrix.c coremark/core_state.c coremark/core_util.c
	$(CLANG) $(CM_CFLAGS) -c htif.c -o htif_epic.o
	$(CLANG) $(CM_CFLAGS) -c crt0.c -o crt0.o
